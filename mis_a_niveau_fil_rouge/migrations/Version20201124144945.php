 ...
 */
final class Version20201124144945 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE niveau ADD CONSTRAINT FK_4BDFF36BE13939B8 FOREIGN KEY (competance_id) REFERENCES niveau (id)');
    }
